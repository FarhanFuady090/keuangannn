    ...
    <div class="mx-auto mt-10 px-6" style="max-width: 1200px">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="p-6 bg-white border-l-4 border-green-500 rounded-lg shadow-md">
                ...
                <p class="text-3xl font-bold text-green-700">Rp {{ number_format($totalTabunganMasuk, 0, ',', '.') }}</p>
            </div>
                    ...
                    <tbody>
                        ...
                        @if(isset($keuanganPerUnit) && count($keuanganPerUnit) > 0)
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center text-green-700">Rp {{ number_format($data->total_saldo_masuk, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center text-red-700">Rp {{ number_format($data->total_saldo_keluar, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-blue-700">Rp {{ number_format($data->total_saldo_akhir, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center text-green-700">Rp {{ number_format($data->total_kas_masuk, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center text-red-700">Rp {{ number_format($data->total_kas_keluar, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-blue-700">Rp {{ number_format($data->total_kas, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center text-green-700">Rp {{ number_format($data->total_tagihan_terbayar, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center text-red-700">Rp {{ number_format($data->total_tagihan_belum_terbayar, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-blue-700">Rp {{ number_format($data->total_tagihan, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-green-700">Rp {{ number_format($data->total_pemasukan, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-red-700">Rp {{ number_format($data->total_pengeluaran, 0, ',', '.') }}</td>
                                <td class="border px-4 py-2 text-center font-semibold text-blue-700">Rp {{ number_format($data->total_akhir, 0, ',', '.') }}</td>
                            </tr>
                            @endforeach
                        @else
                            <tr>
